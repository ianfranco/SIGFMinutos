 ...
 * @author ianfr
 */
public class BusItemsPagaController extends Observable {
    ...
    public BusItemsPagaController(RegistroMinutoController controller, Bus bus) {
        super();
    ...
    public void getBus() {
        ...
        if (row > -1) {
            ...
            this.controller.setBusPaga(bus);
            this.controller.getView().getBusPagaTextField().requestFocus();
            view.dispose();
