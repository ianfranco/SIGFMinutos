 ...
 */
public class InformeGrupoFlotaPagaPrintAction extends AbstractAction {
    ...
    private InputStream file = getClass().getResourceAsStream("/INF-RegistroMinutosGrupoFlota.jrxml");
    private InputStream file2 = getClass().getResourceAsStream("/INF-RegistroMinutosGrupoFlotaIndependiente.jrxml");

    public InformeGrupoFlotaPagaPrintAction() {
    }

    public InformeGrupoFlotaPagaPrintAction(RegistroMinutoController controller) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (option == JOptionPane.YES_OPTION) {
            ...
            this.file2 = null;
            this.file2 = getClass().getResourceAsStream("/INF-RegistroMinutosGrupoFlotaIndependiente.jrxml");
        }else{
            this.report = new ReportController(file);
            this.file = null; 
            this.file = getClass().getResourceAsStream("/INF-RegistroMinutosGrupoFlota.jrxml");
        }
