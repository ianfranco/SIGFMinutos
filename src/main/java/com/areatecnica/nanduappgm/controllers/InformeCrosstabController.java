...
import com.areatecnica.nanduappgm.controllers.ReporteMesController;
 ...
 */
public class InformeCrosstabController {
    ...
    private InputStream file = getClass().getResourceAsStream("/INF-RegistroMinutoMensual.jrxml");

    public InformeCrosstabController() {
    }

    public InformeCrosstabController(ReporteMesView view) {
        this.view = view;
    ...
    public void loadReport() {
        ...
        this.report = new ReportController(this.view.getTabbedPane(), this.file, map, "Crosstab Minutos");
        ...
        this.file = getClass().getResourceAsStream("/INF-RegistroMinutoMensual.jrxml");
    }
